...
**Signal:** Company has a SOC 2 report or Trust Center page (means they sell to enterprise)

---

## CHANNEL 1: LinkedIn Sales Navigator (25 targets)
...
## CHANNEL 2: LinkedIn Organic Inbound (10 targets)

### Strategy
Post content about security questionnaire pain → collect inbound interest

### Post Schedule
- **Day 1:** Post "The Pain Post" from linkedin-scripts.md
- **Day 3:** Post "The Results Post" from linkedin-scripts.md
- **Day 5:** Comment on 10 posts containing "security questionnaire" or "vendor security review"
...
## CHANNEL 3: Company Website Signal Hunting (5 targets)

### What to Look For
Companies that have a public **Trust Center** or **Security** page on their website are selling to enterprise and dealing with questionnaires.

### How to Find Them
Search Google for:
- `site:*.com "trust center" "SOC 2" -vanta.com -drata.com`
- `site:*.com "security questionnaire" "contact us"`
- `"we are SOC 2 certified" site:*.com`
...
## CHANNEL 4: Job Posting Signals (5 targets)

### What to Search
Companies hiring for security questionnaire-related roles have the pain but haven't solved it.

Search LinkedIn Jobs or Indeed for:
- "security questionnaire"
- "vendor security review"
- "GRC analyst"
- "security compliance analyst" AND "questionnaire"
- "trust and safety" AND "enterprise sales"
...
2. DM poster or engaged commenters
3. Add responsive ones to prospect list
...
| Title | VP Sales, CEO, CISO, etc. |
| Company | Company name |
| Size | Employee count |
| ARR Estimate | Based on company size and funding |
| Vertical | HR tech, fintech, healthtech, etc. |
| Source | LinkedIn, job post, Reddit, inbound |
| Trust Center URL | If they have a public security page |
| SOC 2 | Yes/No/Unknown |
| LinkedIn URL | Direct profile link |
| Email | If found |
| Outreach Status | Not contacted / Email sent / Connected / Call booked / Pilot started |
| Outreach Date | When first contacted |
| Notes | Any personalization notes |
...
| Day | Action |
|---|---|
| 0 | LinkedIn connection request (personalized) |
| 1 | Cold email #1 |
| 3 | LinkedIn follow-up DM (if connected) |
| 4 | Cold email #2 |
| 8 | Cold email #3 (with sample output) |
| 14 | Final LinkedIn message: "Timing off? Happy to reconnect later." |
